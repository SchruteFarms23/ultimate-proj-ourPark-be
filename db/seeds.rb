...
User.create(name: "Carl", email: "roman@aol.com", password: "test", weight: "140", height: "5'10", home: "Forest Hills", image_url: "",team_id:5, park_id:277)
...
Stat.create(points: 10, assists: 2, rebounds: 2, blocks: 5, steals: 1, user_id: 1, game_id:1 )
Stat.create(points: 4, assists: 3, rebounds: 6, blocks: 5, steals: 2, user_id: 2, game_id:1 )
Stat.create(points: 7, assists: 4, rebounds: 7, blocks: 5, steals: 2, user_id: 3, game_id:1)
Stat.create(points: 15, assists: 4, rebounds: 8, blocks: 5, steals: 2, user_id: 4, game_id:1)
Stat.create(points: 5, assists: 8, rebounds: 9, blocks: 5, steals: 5, user_id: 5, game_id:1)
Stat.create(points: 4, assists: 2, rebounds: 10, blocks: 5, steals: 2, user_id: 6, game_id:1)
Stat.create(points: 8, assists: 0, rebounds: 7, blocks: 5, steals: 1, user_id: 1, game_id:2)
Stat.create(points: 5, assists: 4, rebounds: 6, blocks: 5, steals: 2, user_id: 2, game_id:2)
Stat.create(points: 8, assists: 5, rebounds: 4, blocks: 5, steals: 2, user_id: 3, game_id:2)
Stat.create(points: 9, assists: 4, rebounds: 5, blocks: 5, steals: 3, user_id: 4, game_id:2)
Stat.create(points: 5, assists: 7, rebounds: 6, blocks: 5, steals: 2, user_id: 5, game_id:2)
Stat.create(points: 7, assists: 2, rebounds: 8, blocks: 5, steals: 1, user_id: 6, game_id:2)
Stat.create(points: 5, assists: 0, rebounds: 2, blocks: 3, steals: 0, user_id: 13, game_id:3)
Stat.create(points: 7, assists: 3, rebounds: 3, blocks: 5, steals: 2, user_id: 13, game_id:4)
Stat.create(points: 9, assists: 7, rebounds: 7, blocks: 5, steals: 3, user_id: 13, game_id:5)
Stat.create(points: 5, assists: 3, rebounds: 3, blocks: 5, steals: 5, user_id: 13, game_id:5)
Stat.create(points: 15, assists: 7, rebounds: 4, blocks: 5, steals: 2, user_id: 13, game_id:5)
Stat.create(points: 4, assists: 2, rebounds: 6, blocks: 5, steals: 1, user_id: 13, game_id:5)
Stat.create(points: 3, assists: 3, rebounds: 3, blocks: 5, steals: 1, user_id: 13, game_id:5)
Stat.create(points: 7, assists: 7, rebounds: 5, blocks: 5, steals: 0, user_id: 1, game_id:5)
Stat.create(points: 9, assists: 4, rebounds: 3, blocks: 5, steals: 0, user_id: 1, game_id:5)
Stat.create(points: 7, assists: 1, rebounds: 4, blocks: 5, steals: 3, user_id: 1, game_id:5)
Stat.create(points: 10, assists: 3, rebounds: 2, blocks: 5, steals: 3, user_id: 2, game_id:5)
Stat.create(points: 11, assists: 5, rebounds: 4, blocks: 5, steals: 2, user_id: 2, game_id:5)
Stat.create(points: 4, assists: 1, rebounds: 8, blocks: 5, steals: 1, user_id: 2, game_id:5)
Stat.create(points: 2, assists: 3, rebounds: 4, blocks: 5, steals: 0, user_id: 2, game_id:5)
Stat.create(points: 6, assists: 3, rebounds: 3, blocks: 5, steals: 0, user_id: 2, game_id:5)
Stat.create(points: 8, assists: 6, rebounds: 6, blocks: 5, steals: 3, user_id: 2, game_id:5)
Stat.create(points: 4, assists: 8, rebounds: 7, blocks: 5, steals: 4, user_id: 2, game_id:5)
Stat.create(points: 8, assists: 2, rebounds: 8, blocks: 5, steals: 2, user_id: 2, game_id:5)
Stat.create(points: 9, assists: 6, rebounds: 4, blocks: 5, steals: 4, user_id: 2, game_id:5)
Stat.create(points: 3, assists: 7, rebounds: 5, blocks: 5, steals: 0, user_id: 2, game_id:5)
Stat.create(points: 7, assists: 7, rebounds: 6, blocks: 5, steals: 0, user_id: 2, game_id:5)
Stat.create(points: 6, assists: 2, rebounds: 8, blocks: 5, steals: 3, user_id: 3, game_id:5)
Stat.create(points: 3, assists: 4, rebounds: 4, blocks: 5, steals: 1, user_id: 3, game_id:5)
Stat.create(points: 11, assists: 6, rebounds: 3, blocks: 5, steals: 0, user_id: 3, game_id:5)
Stat.create(points: 14, assists: 3, rebounds: 2, blocks: 5, steals: 2, user_id: 3, game_id:5)
Stat.create(points: 10, assists: 0, rebounds: 9, blocks: 5, steals: 1, user_id: 3, game_id:5)
Stat.create(points: 3, assists: 4, rebounds: 7, blocks: 5, steals: 2, user_id: 3, game_id:5)
Stat.create(points: 7, assists: 5, rebounds: 4, blocks: 5, steals: 1, user_id: 3, game_id:5)
Stat.create(points: 7, assists: 5, rebounds: 9, blocks: 5, steals: 2, user_id: 3, game_id:5)
Stat.create(points: 8, assists: 9, rebounds: 4, blocks: 5, steals: 3, user_id: 3, game_id:5)
Stat.create(points: 9, assists: 2, rebounds: 7, blocks: 5, steals: 5, user_id: 3, game_id:5)
